...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    public void onSurfaceCreated(EGLConfig eglConfig) {
        ...
        earth.addPlacemark(-90, 0, 0, 1, new float[]{0.0f, 0.4f, 0.0f, 1.0f}, "");
        earth.addPlacemark(0, 180, 0, 1, new float[]{0.0f, 0.4f, 0.0f, 1.0f}, "");

        earth.addPlacemark(-36.84845f, 174.76192f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Auckland");
        earth.addPlacemark(-41.28646f, 174.77623f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Wellington");
        earth.addPlacemark(-33.86748f, 151.20699f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Sydney");
        earth.addPlacemark(52.52000f, 13.40495f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Berlin");
        earth.addPlacemark(38.90719f, -77.03687f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Washington");
        earth.addPlacemark(39.90421f, 116.40739f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Beijing");
        earth.addPlacemark(55.75582f, 37.6173f, 0, 0.2f, new float[]{0.5f, 0.0f, 0.0f, 1.0f}, "Moscow");
