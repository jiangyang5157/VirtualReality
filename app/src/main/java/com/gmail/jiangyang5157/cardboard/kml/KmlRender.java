...
/* package */ class KmlRender {
    ...
    /* package */ KmlRender(AtomMap map, Context context) {
        mContext = context;
        mMap = map;
    ...
    private Object addToMap(KmlPlacemark placemark, KmlGeometry geometry, KmlStyle style, boolean isVisible) {
        ...
        if (geometryType.equals("Point")) {
            AtomMarker marker = addPointToMap(placemark, (KmlPoint) geometry, style);
     ...
     */
    private AtomMarker addPointToMap(KmlPlacemark placemark, KmlPoint point, KmlStyle style) {
