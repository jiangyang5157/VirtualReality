...
class KmlContainerParser {
    ...
    /**
     * Creates a new KmlContainer objects and assigns specific elements read from the XmlPullParser to the new KmlContainer.
     *
    ...
    /**
     * Assigns properties given as an extended data element, which are obtained from an XmlPullParser and stores it in a container,
     * Untyped data only, no simple data or schema, and entity replacements of the form $[dataName] are unsupported.
     */
    private static void setExtendedDataProperties(
    ...
    /**
     * Creates a new placemark object and assigns specific elements read from the XmlPullParser to the Placemark and stores this into the given Container.
     */
